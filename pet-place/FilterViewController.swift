...
class FilterViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    */
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        print("This is Global Var: \(GlobalVar.filter1) and \(GlobalVar.filter2)")
    ...
    */
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if indexPath.section == 0 {
            ...
            print("Global filter1: \(GlobalVar.filter1)")
            ...
            cell.textLabel?.text = sortingOption.name
            print("Global filter2: \(GlobalVar.filter2)")
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if indexPath.section == 0
        {
            ...
            print("This is GlobalVar.filter1: \(GlobalVar.filter1)")
        } else {
            ...
            print("This is GlobalVar.filter2: \(GlobalVar.filter2)")
        }
        tableView.reloadData()
        setTrashButtonEmpty(false)
    }
